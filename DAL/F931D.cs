...
namespace DAL
{
    public class F931D
    {
        ...
        public static List<Entities.F931> GetF931(int anio, int cod_tipo_liq, int nro_liquidacion, string periodo, int opcion)
        {
            List<Entities.F931> lstF931 = new List<Entities.F931>();
            Entities.F931 eSijcor;
