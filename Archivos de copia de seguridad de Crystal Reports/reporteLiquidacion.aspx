<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="reporteLiquidacion.aspx.cs" Inherits="web.secure.reporteLiquidacion" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Año</label>
                                    <asp:TextBox ID="txtAnio" TextMode="Number" CssClass="input-control" runat="server">
                                    </asp:TextBox>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        ErrorMessage="*" ValidationGroup="sueldo" Text="Ingrese fecha de liquidación"
                                        Display="Dynamic" ControlToValidate="txtFechaLiq" ForeColor="Red">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlReportes" runat="server" CssClass="input-control"
                                    AppendDataBoundItems="True"
                                    OnSelectedIndexChanged="ddlReportes_SelectedIndexChanged" AutoPostBack="True">
                                    <asp:ListItem Selected="True" Value="0">Seleccionar</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                    ControlToValidate="ddlReportes" Text="Debe Seleccionar Reportes" ForeColor="Red"
                                    Display="Dynamic" InitialValue="0" ErrorMessage="Debe Seleccionar Reportes"
                                    ValidationGroup="sueldo"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
