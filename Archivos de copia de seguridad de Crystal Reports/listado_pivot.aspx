<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="listado_pivot.aspx.cs" Inherits="web.secure.listado_pivot" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                                ...
                                                <div class="col-md-4">
                                                    <%-- <label>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                                            runat="server" Display="Dynamic" ControlToValidate="txtAnio"
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <%--<label>
                                                        ...
                                                        <asp:DropDownList ID="cmbTipo_liq" runat="server"
                                                            ...
                                                            OnSelectedIndexChanged="cmbTipo_liq_SelectedIndexChanged"
                                                            AutoPostBack="True">
                                                            <asp:ListItem Selected="True" Value="0">Seleccione
                                                                Tipo Liquidacion</asp:ListItem>
                                                        </asp:DropDownList>
                                                        ...
                                                        <asp:CompareValidator ID="CompareValidator1" runat="server"
                                                            ControlToValidate="cmbTipo_liq" Display="Dynamic"
                                                ...
                                                <div class="col-md-3">
                                                    <asp:DropDownList ID="cmbNro_liq" runat="server"
                                                        CssClass="input-control" AppendDataBoundItems="True">
                                                        <asp:ListItem Selected="True" Value="0">Seleccione
                                                            Liquidacion</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-md-6">
                                                    <asp:LinkButton ID="lbtnConsultar" CssClass="btn-control aceptar"
                                                        runat="server" OnClick="lbtnConsultar_Click">
                                                ...
                                                <div class="auto-style1">
                                                    <div class="row" style="padding-top: 10px; overflow: scroll;">
                                                        <asp:GridView ID="GridView1" runat="server"
                                                            CssClass="display compact" CellPadding="4" ForeColor="Black"
