...
{
    public class Aportes_obra_social
    {
        public string descripcion { get; set; }
        public int orden { get; set; }
        public decimal importe { get; set; }

        public Aportes_obra_social()
        {
            descripcion = "";
            orden = 0;
            importe = 0;
        ...
        private static List<Aportes_obra_social> mapeo(SqlDataReader dr)
        {
            List<Aportes_obra_social> lst = new List<Aportes_obra_social>();
            Aportes_obra_social obj;
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    obj = new Aportes_obra_social();
        ...
        public static List<Aportes_obra_social> readAportes(int anio, int cod_tipo_liq, int nro_liq)
        {
            try
            {
                List<Aportes_obra_social> lst = new List<Aportes_obra_social>();
