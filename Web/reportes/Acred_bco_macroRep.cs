...
{
    public class Acred_bco_macroRep
    {
        ...
        private static List<Acred_bco_macroRep> mapeo(SqlDataReader dr)
        {
            List<Acred_bco_macroRep> lst = new List<Acred_bco_macroRep>();
            Acred_bco_macroRep obj;
            string nombre;
            bool si = false;
            int i, j;
        ...
        public static List<Acred_bco_macroRep> read(int anio, int cod_tipo_liq, int nro_liq, decimal porcentaje)
        {
            try
            {
                ...
                strSQL.AppendLine("l.legajo = e.legajo and e.listar = 1 and e.cod_banco = 255");
