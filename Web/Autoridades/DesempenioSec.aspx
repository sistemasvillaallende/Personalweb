<%@ Page Title="" Language="C#" MasterPageFile="~/Autoridades/MPSec.Master"
    AutoEventWireup="true" CodeBehind="DesempenioSec.aspx.cs"
    Inherits="web.Autoridades.DesempenioSec" %>
    ...
    <div class="tab-pane" id="tabInforme">
        ...
        <div class="panel-body">
            <div class="container-fluid p-3 mb-5 bg-white rounded"
                style="background-color: white; padding-left: 25px !important; padding-top: 25px !important;">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="box-header with-border">
                                    <div class="row">
                                        <div class="col-8">
                                            <h5 id="lblSec" runat="server" style="padding-left: 5px; font-size: 20px; color: var(--primary-color); font-weight: 600;">Resultado evaluaciones de desempeño ->
                                            </h5>
                                        </div>
                                        <div class="col-4">
