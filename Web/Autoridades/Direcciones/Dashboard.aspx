<%@ Page Title="" Language="C#" MasterPageFile="~/Autoridades/Direcciones/MPDirecciones.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="web.Autoridades.Direcciones.Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hIdidDireccion" runat="server" />
                ...
                <div class="card-body" style="padding-top: 0;">
                    ...
                    <script>
                        $(document).ready(function () {
                            var valorCookie = $("#ContentPlaceHolder1_hIdidDireccion").val();
                            $.ajax({
                                type: "POST",
                                url: "Dashboard.aspx/ActualizarEstructuraPersonal",
                                data: '{idDireccion: "' + valorCookie + '" }',
