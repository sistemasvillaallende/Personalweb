<%@ Page Title="" Language="C#" MasterPageFile="~/Autoridades/Secretarias/MPSec.Master" AutoEventWireup="true" CodeBehind="Evaluacion.aspx.cs" Inherits="web.Autoridades.Secretarias.Evaluacion" %>
            ...
            <div class="col-md-4">
                <div class="btn-group pull-right">
                    ...
                    <button type="button" class="btn btn-info" id="btnNuevo" runat="server"
                        ...
                        Nuevo</button>
                    <a href="DesempenioSec.aspx" class="btn btn-danger" id="btnSalirEv" runat="server">
                        Cancelar</a>
