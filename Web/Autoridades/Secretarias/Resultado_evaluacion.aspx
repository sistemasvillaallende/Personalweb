<%@ Page Title="" Language="C#" MasterPageFile="~/Autoridades/Secretarias/MPSec.Master" AutoEventWireup="true" CodeBehind="Resultado_evaluacion.aspx.cs" Inherits="web.Autoridades.Secretarias.Resultado_evaluacion" %>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12" style="display: block">
            <div class="card">
                <div class="card-header border-0" style="padding-bottom: 0;">
                    <h5 style="padding-left: 5px; font-size: 20px; color: var(--primary-color); font-weight: 600;">Resultado evaluaciones de desempeño 2023
                    </h5>
