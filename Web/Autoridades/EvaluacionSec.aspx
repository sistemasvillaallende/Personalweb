<%@ Page Title="" Language="C#" MasterPageFile="~/Autoridades/MPSec.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionSec.aspx.cs"
    Inherits="web.Autoridades.EvaluacionSec" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    ...
    <div class="container-fluid p-3 mb-5 bg-white rounded"
        style="background-color: white; padding-left: 25px !important; margin-top: 50px !important;">
        ...
        <div class="row" style="margin-bottom: 20px; border: solid 3px lightgray; padding: 15px; border-radius: 15px; font-size: 18px; font-weight: 500; margin-left: 1px; margin-right: 5px;">
            ...
            <div class="col-md-4" style="display: none;">
                ...
                <h3 class="box-title" id="lblEvaluado"
                    ...
                    <span style="color: var(--primary-color)"></span></h3>
            ...
            <div class="col-md-4" style="display: none;">
                <div class="btn-group pull-right">
                    ...
                    <button type="button" class="btn btn-info" id="btnNuevo" runat="server"
                        ...
                        Nuevo</button>
                    <a href="DesempenioSec.aspx" class="btn btn-danger" id="btnSalirEv" runat="server">Cancelar</a>
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-col-12" style="text-align: right">
                <a id="btnCancela" onserverclick="btnCancela_ServerClick" runat="server" href="#" class="btn btn-outline-dark">Cancelar</a>
                <asp:LinkButton ID="btnAceptar" CssClass="btn btn-dark" OnClick="btnAceptar_Click" runat="server">Aceptar</asp:LinkButton>
            </div>
        </div>
    </div>
    <div class="row">
