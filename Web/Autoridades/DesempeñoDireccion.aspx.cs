...
{
    public partial class DesempeñoDireccion : System.Web.UI.Page
    {
    ...
    (HtmlGenericControl)Master.FindControl("liDesempeño");
        ...
        private void BindList()
        {
            ...
            try
            {
                ...
                {
                    CargarGrilla(
                        int.Parse(Request.QueryString["id_direccion"].ToString()));
                }
            }
            catch (Exception ex)
            {
        ...
        protected void grdList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    "EvaluacionDireccion.aspx?legajo={0}&idFicha={1}",
