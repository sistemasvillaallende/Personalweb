function appriseGreen(string,args,callback)
...
var aHeight = $(document).height(); var aWidth = $(document).width(); $('body').append('<div class="appriseOverlay" id="aOverlay"></div>'); $('.appriseOverlay').css('height', aHeight).css('width', aWidth).fadeIn(100); $('body').append('<div class="appriseOuterGreen"></div>'); $('.appriseOuterGreen').append('<div class="appriseInner"></div>'); $('.appriseInner').append(string); $('.appriseOuterGreen').css("left", ($(window).width() - $('.appriseOuterGreen').width()) / 2 + $(window).scrollLeft() + "px"); if (args)
{if(args['animate'])
{var aniSpeed=args['animate'];if(isNaN(aniSpeed)){aniSpeed=400;}
$('.appriseOuterGreen').css('top', '-200px').show().animate({ top: "100px" }, aniSpeed);
}
else
{ $('.appriseOuterGreen').css('top', '100px').fadeIn(200); } 
}
else
{ $('.appriseOuterGreen').css('top', '100px').fadeIn(200); }
if(args)
...
$('.appriseOverlay').remove(); $('.appriseOuterGreen').remove(); if (callback)
