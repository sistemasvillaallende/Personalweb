 <%@ Page Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true" CodeBehind="categorias_empleados_monotributo.aspx.cs" Inherits="web.secure.categorias_empleados_monotributo" %>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="auto-style1" style="margin-top: 20px;">
                                            <asp:GridView ID="gvCategoriasMono"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Id categoria monotributo" ItemStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <p>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="cliente"
                                                Text="*" ForeColor="Red" Display="Dynamic"
                                                ErrorMessage="Ingrese la Descripcion de la Categoria" ControlToValidate="txtCategoria">
                                            </asp:RequiredFieldValidator>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Monto</label>
                                            ...
                                            <asp:RequiredFieldValidator ID="rv4" runat="server" ValidationGroup="cliente"
                                                Text="*" ForeColor="Red" Display="Dynamic"
                                                ErrorMessage="Ingrese Sueldo Basico" ControlToValidate="txtMonto">
                                            </asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />--%>
                                    ...
                                    <div style="overflow: scroll; height: 150px;">
                                        <asp:GridView ID="gvCategoriasMono2" runat="server"
                                            ...
                                            OnRowCommand="gvCategoriasMono2_RowCommand" OnRowCreated="gvCategoriasMono2_RowCreated"
                                            formnovalidate=""
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="id_profesional_monotributo" HeaderText="Codigo" />
                                                <asp:BoundField DataField="categoria" HeaderText="Descripcion" />
                                                <asp:BoundField DataField="monto" HeaderText="Basico" />
