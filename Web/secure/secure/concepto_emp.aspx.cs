...
namespace web.secure
{
    public partial class concepto_emp : System.Web.UI.Page
    {
        ...
        List<Entities.ConceptoLiqxEmp> lstDetalleDel = new List<Entities.ConceptoLiqxEmp>();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Session.Add("DetalleDel", lstDetalleDel);
        ...
        protected void btnAceptar_ServerClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                detalle.observaciones = txtObservaciones.Text;
        ...
        protected void btnConfirma_Click(object sender, EventArgs e)
        {
            ...
            lstDetalle = (List<Entities.ConceptoLiqxEmp>)Session["Detalle"];
            lstDetalleDel = (List<Entities.ConceptoLiqxEmp>)Session["DetalleDel"];
