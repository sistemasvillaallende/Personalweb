...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="padding-top: 60px;">
        ...
        <div style="padding: 10px; width: 30%; background-color: White; box-shadow: 0px 0px 10px #000;"
            id="divModalDetalle"
            runat="server"
                        ...
                        <div class="modal-body" id="m1" style="min-height: 320px;">
                            ...
                            <div class="row">
                                <%--<div class="form-group col-md-12">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Motivo por el cual se realiza el cambio"
                                        ControlToValidate="txtObservacion" ForeColor="#FF3300" Display="Dynamic" ValidationGroup="cliente">*</asp:RequiredFieldValidator>
                                </div>--%>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Motivo/Obs:</label>
                                        <asp:TextBox runat="server" TextMode="MultiLine" CssClass="form-control" ID="txtObservaciones" ClientIDMode="Static"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Motivo por el cual se realiza este trámite"
                                            ControlToValidate="txtObservaciones" ForeColor="#FF3300" Display="Dynamic" ValidationGroup="cliente">*</asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
