<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="novedades2.aspx.cs" Inherits="web.secure.novedades2" UICulture="es" Culture="es-MX" %>
                        ...
                        <asp:UpdatePanel ID="PanelInfomacion" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div class="alert alert-warning alert-dismissible" runat="server" id="divError"
                                    visible="false" role="alert">
                                    <button type="button" class="close" data-dismiss="alert"
                                        onclick="__doPostBack('<%=PanelInfomacion.ClientID%>', 'Error');">
                                        <span aria-hidden="true">×</span></button>
                                    </button>
                                    <h4>Error!</h4>
                    ...
                    <div class="box box-primary">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="rv1" runat="server" ErrorMessage="*"
                                                    ...
                                                    ControlToValidate="txtAnio" ForeColor="Red">
                        ...
                        <div class="box-footer" style="text-align: right;">
                                        ...
                                        <%--<div class="box-body">--%>
                                            <asp:GridView ID="gvConceptos" CssClass="table" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="nro_parametro" HeaderText="Nro"
                                                    ...
                                                    <%--<asp:TemplateField HeaderText="Accion">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnElimiar" CommandName="eliminar"
                            ...
                            <div class="box-footer">
                                <asp:LinkButton ID="btnCancelar" OnClick="btnCancelar_Click"
                                    CssClass="btn-control cancelar" runat="server">
                                    <span class="fa fa-sign-out"></span>&nbsp; Cancelar
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnAceptar" OnClick="btnAceptar_Click"
                                    CssClass="btn-control aceptar" runat="server" ValidationGroup="sueldo">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div id="Image">
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/imagenes/conceptos.jpg"
