<%@ Page Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="categorias_empleados_monotributo_hist.aspx.cs"
    Inherits="web.secure.categorias_empleados_monotributo_hist" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Historial Categoría Empleados Monotributo</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div>
                                    <asp:GridView ID="gvCategoriasMono" CssClass="table table-hover table-bordered"
                                        runat="server" OnRowDataBound="gvCategoriasMono_RowDataBound"
                                        OnRowCommand="gvCategoriasMono_RowCommand" CellPadding="4"
                                        AutoGenerateColumns="False" ForeColor="#333333" GridLines="None"
                                        DataKeyNames="categoria" AllowPaging="True"
                                        OnPageIndexChanging="gvCategoriasMono_PageIndexChanging" PageSize="8">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775">
                                        </AlternatingRowStyle>
                                        <Columns>
                                            <asp:TemplateField HeaderText="Categoría" ItemStyle-Width="50%">
                                                <ItemTemplate>
                                                    <p>
                                            ...
                                            <asp:TemplateField HeaderText="Número Movimiento" ItemStyle-Width="10%">
                                                <ItemTemplate>
                                                    <p>
                                                        <asp:Label ID="lblMovimiento" runat="server" Text="">
                                                        </asp:Label>
                                                    </p>
                                                </ItemTemplate>
                                                <ItemStyle Width="10%" />
                                            ...
                                            <asp:TemplateField HeaderText="Fecha Movimiento" ItemStyle-Width="20%">
                                                <ItemTemplate>
                                                    <p>
                                                        <asp:Label ID="lblFechaMovimiento" runat="server" Text="">
                                                        </asp:Label>
                                                    </p>
                                                </ItemTemplate>
                                                <ItemStyle Width="20%" />
