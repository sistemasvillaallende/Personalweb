<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="informeconceptosv2.aspx.cs" Inherits="web.secure.informeconceptosv2" %>
                            ...
                            <div class="col-md-12">
                                <div class="box box-primary">
                                        ...
                                        <%--<h3 class="box-title">Productos</h3>--%>
                                            <div class="widget-user-image">
                                                <span class="glyphicon glyphicon-file"
                                                    style="float: left; font-size: 40px;"></span>
                                            </div>
                                            <!-- /.widget-user-image -->
                                            <h3 class="widget-user-username"><strong>INFORME de CONCEPTO de
                                                    Liquidación</strong></h3>
                                            <a href="#" onclick="printDiv('tabInforme')"
                                    ...
                                    <div class="box-body">
                                        <div class="col-md-12">
                                            <%--<div id="divFiltros">
                                                <asp:UpdatePanel ID="uPanelFiltros" UpdateMode="Conditional"
                                                    runat="server">--%>
                                                    <%--<Triggers>
                                                        ...
                                                        <%--<ContentTemplate>--%>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlPeriodos"
                                                                        CssClass="input-control" runat="server">
                                                                        <asp:ListItem Text="Sin filtro" Value="0">
                                                                        </asp:ListItem>
                                                                        <asp:ListItem Text="Año a partir de" Value="1">
                                                                        </asp:ListItem>
                                                                        <%--<asp:ListItem Text="Año hasta" Value="2"
                                                                            Enabled="false"></asp:ListItem>--%>
                                                                            <asp:ListItem Text="Año entre" Value="3">
                                                                            </asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <br />
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <asp:TextBox ID="txtDesde" Enabled="false"
                                                                                CssClass="input-control" runat="server"
                                                                                Placeholder="Año Desde"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                    <br />
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <asp:TextBox ID="txtHasta" Enabled="false"
                                                                                CssClass="input-control" runat="server"
                                                                                Placeholder="Año Hasta"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label>Tipo Liquidacion</label>
                                                                    <asp:DropDownList ID="cmbTipo_liq" runat="server"
                                                                        CssClass="input-control"
                                                                        AppendDataBoundItems="True">
                                                                        <asp:ListItem Selected="True" Value="0">
                                                                            Seleccione Tipo Liquidacion</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator1" runat="server"
                                                                        Display="Dynamic"
                                                                        ControlToValidate="cmbTipo_liq"
                                                                    ...
                                                                    <div class="row">
                                                                        <%--<div class="col-md-12">
                                                                            <asp:DropDownList ID="cmbNro_liq"
                                                                                runat="server" CssClass="input-control"
                                                                                AppendDataBoundItems="True">
                                                                                <asp:ListItem Selected="True" Value="0">
                                                                                    Seleccione Liquidacion
                                                                                </asp:ListItem>
                                                                            </asp:DropDownList>
                                                                    </div>--%>
                                                                </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:TextBox ID="txtCod_concepto" runat="server"
                                                                    CssClass="input-control" TextMode="Number"
                                                                    placeholder="Cod Concepto"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <asp:DropDownList ID="ddConcepto" runat="server"
                                                                            CssClass="input-control"
                                                                            AppendDataBoundItems="True"
                                                                            OnSelectedIndexChanged="ddConcepto_SelectedIndexChanged"
                                                                            AutoPostBack="true">
                                                                            <asp:ListItem Selected="True" Value="0">
                                                                                Seleccione Concepto</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:TextBox ID="txtLegajo" runat="server"
                                                                    CssClass="input-control" TextMode="Number"
                                                                    placeholder="Legajo"
                                                                    OnTextChanged="txtLegajo_TextChanged"
                                                                    AutoPostBack="true">
                                                                </asp:TextBox>
                                                                <br />
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <asp:DropDownList ID="ddLegajos" runat="server"
                                                                            CssClass="input-control"
                                                                            AppendDataBoundItems="True"
                                                                            OnSelectedIndexChanged="ddLegajos_SelectedIndexChanged"
                                                                            AutoPostBack="True">
                                                                            <asp:ListItem Selected="True" Value="0">
                                                                                Seleccione Legajo</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="text-align: right;">
                                                <div class="btn-group" style="padding-bottom: 20px;">
                                                    <button type="button" class="btn-control secundary"
                                                    ...
                                                    <asp:Button ID="cmdConsulta" runat="server" Text="Consultar"
                                                        class="btn-control aceptar" ValidationGroup="consulta"
                                                        OnClick="cmdConsulta_Click" />
                                                    <%--<asp:Button ID="cmdExportar" runat="server"
                                                        CssClass="btn-control excel" OnClick="cmdExportar_Click"
                                                        Text="Exportar a Excel" />--%>
                                                    <asp:Button ID="cmdSalir" runat="server"
                                                        CssClass="btn-control cancelar" OnClick="cmdSalir_Click"
                                                        Text="Salir" />
                                                    <%-- <button type="button" runat="server" id="btnExportExcel"
                                                        onserverclick="btnExportExcel_ServerClick"
                                                        class="btn-control excel" data-toggle="modal"
                                                        data-target="#page-change-name">
                                                        <span class="glyphicon glyphicon-save"></span>&nbsp; Exportar a
                                                        Excel
                                                        </button>--%>
                                                </div>
                                            </div>
                                ...
                                <%--<section class="content">--%>
                                    <%--<div id="movimientos_caja">
                            </div>--%>
                            <%--<div class="outer_div">--%>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3 style="color: dimgray;"><strong>
                                                <asp:Label ID="lblTituloInforme" Font-Bold="true" Font-Size="18"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row" style="padding-top: 10px; overflow: scroll;">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="display compact"
