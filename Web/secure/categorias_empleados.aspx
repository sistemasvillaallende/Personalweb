            ...
            <asp:UpdatePanel ID="uPanelCliente" UpdateMode="Conditional" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-6"">
                                ...
                                <button class="btn-control aceptar" type="button" id="btnBuscar" runat="server"
                        ...
                        <div class="col-sm-6">
                            <div class="btn-group pull-right" id="divActualiza" runat="server">
                                <asp:LinkButton ID="lbtnActualizar_valores" CssClass="btn-control secondary"
                                    runat="server" OnClick="lbtnActualizar_valores_Click">
                                    <i class="fa fa-money"></i>&nbsp;Actualizar
                                    Valores
                                </asp:LinkButton>
                                <asp:LinkButton ID="lbtnNuevo" CssClass="btn-control primario" runat="server"
                                    OnClick="lbtnNuevo_Click">
                                    <i class="fa fa-plus"></i>&nbsp;Nueva
                                </asp:LinkButton>
                                <asp:LinkButton ID="LinkExportar" CssClass="btn-control excel" runat="server"
                        ...
                        <div class="form-group" style="text-align: right" id="divAcepta" visible="false" runat="server">
                            <asp:Button ID="btnCancelarValores" CssClass="btn-control cancelar" runat="server"
                                Text="Cancelar" OnClick="btnCancelarValores_Click" />
                            <asp:Button ID="btnAceptarValores" runat="server" CssClass="btn-control aceptar"
                    ...
                    <div class="row">
                        <%--<div class="col-md-10 col-md-offset-1" id="divLista" runat="server">--%>
                            <div class="auto-style1">
                                <asp:GridView ID="gvCategorias" CssClass="table table-hover" runat="server"
                                    OnRowDataBound="gvCategorias_RowDataBound" OnRowCommand="gvCategorias_RowCommand"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Fecha Alta" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <p>
                                                    <asp:Label ID="lblFecha_alta" runat="server" Text="">
                                                    </asp:Label>
                                                </p>
                                        ...
                                        <asp:TemplateField HeaderText="Cantidad Empleados" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                <p>
                                        ...
                                        <asp:TemplateField HeaderText="Descripcion Categoria" ItemStyle-Width="38%">
                                            <ItemTemplate>
                                                <p>
                                                    <asp:Label ID="lblDes_categoria" runat="server" Text="">
                                                    </asp:Label>
                                                </p>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <asp:LinkButton ID="lbtnEditar" CommandName="editar"
                                                                    ...
                                                                    runat="server" class="dropdown-item">
                                                            ...
                                                            <li>
                                                                <asp:LinkButton ID="lbtaDetalles" CommandName="detalles"
                                                                    CommandArgument="<%# Container.DataItemIndex %>"
                                                                    runat="server" class="dropdown-item">
                                                                    <i class="fa fa-edit"></i>&nbsp
                                                                    Detalles
                    ...
                    <ajaxToolkit:ModalPopupExtender runat="server" BackgroundCssClass="modalBackground"
                        PopupControlID="modalDatosCategorias" BehaviorID="modalPopupExtender" TargetControlID="Button1"
                    ...
                    <div id="modalDatosCategorias" runat="server">
                        <div class="modal-windows">
                            ...
                            <div class="modal-body" id="activity">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <asp:RequiredFieldValidator ID="rv1" runat="server" ValidationGroup="cliente"
                                            Text="*" ForeColor="Red" Display="Dynamic" ErrorMessage="Ingrese Codigo"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:TextBox ID="txtDes_categoria" CssClass="input-control" runat="server">
                                        </asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                            ValidationGroup="cliente" Text="*" ForeColor="Red" Display="Dynamic"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <asp:TextBox ID="txtSueldo_basico" CssClass="input-control" runat="server">
                                        </asp:TextBox>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button ID="btnCancelar" runat="server" CssClass="btn-control cancelar"
                                    Text="Cancelar" OnClick="btnCancelar_Click" />
                                <asp:Button ID="btnAceptar" runat="server" ValidationGroup="cliente"
                                    CssClass="btn-control aceptar" Text="Aceptar" OnClick="btnAceptar_Click" />
                    ...
                    <%-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        <ajaxToolkit:ModalPopupExtender runat="server" BackgroundCssClass="modalBackground"
                            PopupControlID="modalActualizarMontos" BehaviorID="popupActualizarMontos"
                            TargetControlID="Button2" ID="popupActualizarMontos">
                        </ajaxToolkit:ModalPopupExtender>
                        <div style="padding: 10px; width: 70%; background-color: White; box-shadow: 0px 0px 10px #000;"
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <%--<asp:Label ID="Label9" runat="server" Text="Asunto:" Width="100px">
                                        </asp:Label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn btn-info" type="button" id="cmdBuscar2"
                                                    runat="server" onserverclick="cmdBuscar2_ServerClick"
                                        ...
                                        <div style="overflow: scroll; height: 150px;">
                                            <asp:GridView ID="gvCategorias2" runat="server" AutoGenerateColumns="False"
                                                CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="grid"
                                                OnRowCommand="gvCategorias2_RowCommand"
                                                OnRowCreated="gvCategorias2_RowCreated" formnovalidate=""
                                                DataKeyNames="cod_categoria, sueldo_basico" AllowPaging="True"
                                                PageSize="8" OnPageIndexChanging="gvCategorias2_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Seleccionar">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="imgbSeleccionar" runat="server"
                                        ...
                                        <div class="modal-footer">
                                            <asp:LinkButton ID="lbtnCancelarBuscador" CssClass="btn btn-default"
                                                runat="server" CausesValidation="False"
                                                OnClick="lbtnCancelarBuscador_Click">
                                                <i class="fa fa-times" aria-hidden="true"></i>
                                                Cancelar
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="lbtnSalirBuscador" CssClass="btn btn-default"
                                                runat="server" CausesValidation="False"
