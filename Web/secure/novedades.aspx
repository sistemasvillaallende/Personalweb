<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="novedades.aspx.cs" Inherits="web.secure.novedades" UICulture="es" Culture="es-MX" %>
    ...
    <%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                            ...
                                            <div class="form-group">
                                                <div class="box-body" style="padding-left: 20px; padding-right: 20px;">
                                                    <div class="row">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                                                runat="server" ControlToValidate="txtAnio" Text="*"
                                                                ForeColor="Red" Display="Dynamic"
                                                                ErrorMessage="Debe Ingresar Año"
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <asp:DropDownList ID="txtTipo_liq" runat="server"
                                                                CssClass="input-control" AppendDataBoundItems="True"
                                                                OnSelectedIndexChanged="txtTipo_liq_SelectedIndexChanged"
                                                                AutoPostBack="True">
                                                                <asp:ListItem Selected="True" Value="0">Seleccionar
                                                                </asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                                                runat="server" ControlToValidate="txtTipo_liq" Text="*"
                                                                ForeColor="Red" Display="Dynamic" InitialValue="0"
                                                                ErrorMessage="Debe Ingresar TipoLiquidacion"
                                                                ValidationGroup="Validation1">*
                                                            </asp:RequiredFieldValidator>
                                                            <asp:CompareValidator ID="CompareValidator1" runat="server"
                                                                ControlToValidate="txtTipo_liq" Text="*" ForeColor="Red"
                                                                Display="Dynamic"
                                                                ErrorMessage="El valor debe ser Numerico"
                                                                Operator="DataTypeCheck" Type="Integer"
                                                                ValidationGroup="Validation1">*</asp:CompareValidator>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <asp:DropDownList ID="txtNro_liq" runat="server"
                                                                CssClass="input-control" AppendDataBoundItems="True"
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                                runat="server" ControlToValidate="txtNro_liq"
                                                                ErrorMessage="Debe Ingresar Nro Liquidacion" Text="*"
                                                                ForeColor="Red" Display="Dynamic" InitialValue="0"
                                                                ValidationGroup="Validation1">*
                                                            </asp:RequiredFieldValidator>
                                                            <asp:CompareValidator ID="CompareValidator3" runat="server"
                                                                ControlToValidate="txtNro_liq"
                                                                ErrorMessage="El valor debe ser Numerico" Text="*"
                                                                ForeColor="Red" Display="Dynamic"
                                                                Operator="DataTypeCheck" Type="Integer"
                                                                ValidationGroup="Validation1">*</asp:CompareValidator>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <label for="txtCod_concepto" class="form-label">Cod Concepto:</label>
                                                ...
                                                <div class="col-md-4">
                                                    <%-- <div class="input-group">
                                                        <input type="text" class="input-control"
                                                            placeholder="Buscar por nombre" id="q" onkeyup="load(1);" />
                                                        <span class="input-group-btn">
                                                            <button class="btn-control aceptar" type="button"
                                                                onclick="load(1);"><i class="fa fa-search"></i></button>
                                                        </span>
                                                </div>--%>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="btn-group pull-right">
                                                    <asp:LinkButton ID="lbtnCargar_legajos"
                                                        CssClass="btn-control primary" runat="server"
                                                        OnClick="btnCargar_Legajos_ServerClick">
                                                        <i class="fa fa-plus"></i> Cargar Legajos
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnEliminaTodos" CssClass="btn-control peligro"
                                                        runat="server" OnClick="lbtnEliminaTodos_Click"
                                                    ...
                                                    <div>
                                                        <asp:GridView ID="gvDetalle" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="cod_concepto_liq"
                                                                    HeaderText="Codigo" />
                                                                <asp:BoundField DataField="concepto"
                                                                    HeaderText="Concepto" />
                                                                <asp:BoundField DataField="nro_parametro"
                                                                    HeaderText="Nro Parametro">
                                                                    <%--<HeaderStyle BackColor="#d9edf7" />--%>
                                                                </asp:BoundField>
                                                                <asp:BoundField DataField="valor_parametro"
                                                                    HeaderText="Valor/Monto" DataFormatString="{0:C}">
                                                                    <%--<HeaderStyle BackColor="#d9edf7" />--%>
                                                                </asp:BoundField>
                                                    ...
                                                    <div class="row" style="text-align: right;">
                                                        <div class="col-xs-9">
                                                            <h4 class="modal-title"><strong>
                                                                    <asp:Label ID="lblTituloInforme" Font-Bold="true"
                                                                        Font-Size="18" ForeColor="GrayText"
                                                                        runat="server" Text="Totales">
                                                                    </asp:Label>
                                                                </strong></h4>
                                                        </div>
                                                        <div class="col-xs-3"
                                                            style="padding-right: 30px; text-align: right;">
                                                            <asp:Label ID="Label4" Font-Bold="true" Font-Size="12"
                                                                ForeColor="GrayText" runat="server" Text="Total:  ">
                                                            </asp:Label>
                                                            <asp:Label ID="lblTotal" Font-Bold="true" Font-Size="12"
                                                                ForeColor="GrayText" runat="server" Text=""></asp:Label>
                                                            <br />
                                                            <asp:Label ID="Label5" Font-Bold="true" Font-Size="12"
                                                                ForeColor="GrayText" runat="server" Text="Cant.Mov.:  ">
                                                            </asp:Label>
                                                            <asp:Label ID="lblCantReg" Font-Bold="true" Font-Size="12"
                                                                ForeColor="GrayText" runat="server" Text=""></asp:Label>
                                                            <br />
                                                        </div>
                                                    </div>
            ...
            <ajaxToolkit:ModalPopupExtender ID="popUpConcepto" runat="server" PopupControlID="Div1"
                TargetControlID="Button1" BackgroundCssClass="backgroundColor">
            </ajaxToolkit:ModalPopupExtender>
            <div style="padding: 10px; width: 60%; background-color: White; box-shadow: 0px 0px 10px #000;" id="Div1"
                runat="server">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="modal-header">
                            <button type="button" runat="server" id="btnCloseModalConcepto"
                                onserverclick="btnCloseModalConcepto_ServerClick" class="close" data-dismiss="modal"
                                aria-label="Close">
                        ...
                        <div class="input-group">
                            <input type="text" class="input-control" id="txtInput" runat="server" />
                            <span class="input-group-btn">
                                <button class="btn btn-facebook" type="button" id="cmdBuscar" runat="server"
                                    onserverclick="cmdBuscar_ServerClick" causesvalidation="False">
                                    <span class="fa fa-search"></span>Buscar</button>
                            </span>
                        </div>
                        <br />
                        <div style="overflow: scroll; height: 150px;">
                            <asp:GridView ID="grdConceptos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ForeColor="#333333" GridLines="None" CssClass="table"
                                OnRowCommand="grdConceptos_RowCommand" OnRowCreated="grdConceptos_RowCreated"
                                formnovalidate="" DataKeyNames="cod_concepto, des_concepto_liq">
            ...
            <ajaxToolkit:ModalPopupExtender ID="popUpDetalleLegajos" runat="server" PopupControlID="modalAddItems"
                BehaviorID="popUpDetalleLegajos" TargetControlID="Button2" OkControlID="btnAceptar"
                BackgroundCssClass="backgroundColor">
            </ajaxToolkit:ModalPopupExtender>
            <div style="padding: 10px; width: 50%; background-color: White; box-shadow: 0px 0px 10px #000;"
                id="modalAddItems" runat="server" class="modal-windows">
                    ...
                    <asp:UpdatePanel ID="UpdatePanelLegajo" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">
                                    <asp:Label ID="lblTituloFormModal" runat="server" Text="Agregar Legajos">
                                    </asp:Label>
                                </h4>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtLegajo" runat="server" Width="50%" autocomplete="false"
                                    placeholder="Ingrese Legajo" AutoPostBack="True" CssClass="input-control"
                                    OnTextChanged="txtLegajo_TextChanged"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator6" runat="server"
                                    ValidationGroup="Validation2" ControlToValidate="txtLegajo"
                                    ErrorMessage="Debe Ingresar Legajo" Type="Integer" Text="*" ForeColor="Red"
                                    Display="Dynamic" Operator="DataTypeCheck">*</asp:CompareValidator>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                    ControlToValidate="txtLegajo" ErrorMessage="Debe ingresar Legajo"
                                    SetFocusOnError="True" Text="*" ForeColor="Red" Display="Dynamic"
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNombre" runat="server" autocomplete="false" Width="90%"
                                    placeholder="Nombre" CssClass="input-control"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Valor o Monto</label>
                                <br />
                                <asp:TextBox ID="txtValor" runat="server" Width="90%" autocomplete="false"
                                    CssClass="input-control" placeholder="Valor / Monto"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator5" runat="server"
                                    ValidationGroup="Validation2" ControlToValidate="txtValor"
                                    ErrorMessage="Debe Ingresar Valor" Type="Double" Text="*" ForeColor="Red"
                                    Display="Dynamic" Operator="DataTypeCheck">*</asp:CompareValidator>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                    ControlToValidate="txtValor" ErrorMessage="Debe ingresa Valor" Text="*"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <asp:TextBox ID="txtObs" runat="server" TextMode="MultiLine"
                                        CssClass="input-control" placeholder="Texto"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        ControlToValidate="txtObs" ErrorMessage="Debe ingresa Observaciones"
                                        Display="Dynamic" ValidationGroup="Validation2">*</asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">--%>
                                    <%--<ContentTemplate>--%>
                                        <div class="modal-footer">
                                            <asp:Button ID="btnAceptar" runat="server" CssClass="btn-control aceptar"
                                                Text="Aceptar" OnClick="btnAceptar_ServerClick"
