<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="concepto_emp.aspx.cs" Inherits="web.secure.concepto_emp" %>
...
<body class="login-page">
    ...
    <form id="form1" runat="server">
            ...
            <div class="col-md-12" style="text-align: right;">
                <%--<div class="btn-group pull-righ" style="padding-bottom: 20px;">
                                        ...
                                        <asp:Button ID="btnExporCtaCte" CssClass="btn btn-app btn-link" runat="server"
                                            Text="Exportar a Excel" OnClick="btnExporCtaCte_Click" />
                                        <asp:Button ID="btnSalir" runat="server" CssClass="btn btn-app bg-orange margin"
        ...
        <ajaxToolkit:ModalPopupExtender runat="server" BackgroundCssClass="backgroundColor"
            PopupControlID="divBusqueda" BehaviorID="modalPopupBusqueda" TargetControlID="Button1"
            ID="modalPopupBusqueda">
        </ajaxToolkit:ModalPopupExtender>
        <div style="padding: 10px; width: 60%; background-color: White; box-shadow: 0px 0px 10px #000;"
            id="divBusqueda" runat="server">
                    ...
                    <fieldset class="register">
                        ...
                        <div>
                            <asp:GridView ID="grdConceptos" runat="server" AutoGenerateColumns="False"
                                CellPadding="4" ForeColor="Black" GridLines="Horizontal" formnovalidate=""
                                DataKeyNames="cod_concepto,des_concepto_liq" BackColor="White"
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <asp:CompareValidator ID="CompareValidator6" runat="server"
                                    ...
                                    ErrorMessage="Debe Ingresar Legajo" Type="Integer" Operator="DataTypeCheck"
