<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="concepto_emp.aspx.cs" Inherits="web.secure.concepto_emp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" style="margin-top: 35px; padding-top: 25px">
                ...
                <div style="padding: 10px; width: 40%; background-color: White; box-shadow: 0px 0px 10px #000;"
                    id="divModalDetalle" runat="server" class="panel panel-info">
                                ...
                                <div class="modal-footer col-md-12">
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn btn-primary" runat="server" id="btnAceptar"
                                            ...
                                            Aceptar</button>
                                        <button type="button" class="btn btn-default" runat="server" id="btnCancelar"
