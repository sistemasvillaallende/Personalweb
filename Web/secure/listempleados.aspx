<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MasterNew.Master" AutoEventWireup="true"
    CodeBehind="listempleados.aspx.cs" Inherits="Web.secure.listempleados" UICulture="es" Culture="es-MX" %>
    ...
    <%@ Register TagPrefix="ajaxToolkit" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8" style="text-align: right;">
                                            <asp:LinkButton ID="lbtnNuevo" CssClass="btn btn-outline-primary"
                                                runat="server" OnClick="cmdNuevo_Click">
                                                <i class="fa fa-user"></i>&nbsp; Nuevo
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="lbtnRecibos" CssClass="btn btn-outline-primary"
                                                runat="server" OnClick="cmdRecibos_Click">
                                                <i class="fa fa-files-o"></i>&nbsp; Recibos
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="lbtnReportes" CssClass="btn btn-outline-primary"
                                                runat="server" OnClick="btnReportes_Click">
                                                <i class="fa fa-print"></i>&nbsp; Reportes
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="lbtnSalir" CssClass="btn btn-outline-primary"
                                                runat="server" OnClick="cmdSalir_Click">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddFindBy" runat="server"
                                                    Style="border-color: var(--bs-gray-400)" CssClass="form-control"
                                        ...
                                        <div class="col-md-3" style="padding-top: 29px;">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                    style="border-color: var(--bs-gray-400)" id="txtInput"
                                                    runat="server" />
                            ...
                            <div class="auto-style1" style="margin-top: -30px;">
                                <asp:GridView ID="grdList" runat="server" AutoGenerateColumns="False"
                                    EmptyDataText="No hay resultados..." Width="100%" CssClass="table" CellPadding="4"
                                    ForeColor="Black" OnRowDataBound="grdList_RowDataBound" DataKeyNames="legajo"
                                    GridLines="Horizontal" Font-Names="Ubuntu, sans-serif;"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Legajo" Visible="False">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlDetalles" runat="server"
                                                    Text='<%# DataBinder.Eval(Container.DataItem,"legajo").ToString()%>'
                                                ...
                                                <div class="dropdown">
                                                    <div class="btn-group dropleft">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="PerfilEmpleado.aspx?legajo=<%#Eval("legajo")%>">Ver</a>
                                                            <a class="dropdown-item"
                                        ...
                                        <asp:BoundField DataField="nro_documento" HeaderText="Nº Doc."
                                            Visible="False" />
                                        <asp:BoundField DataField="nro_cta_sb" HeaderText="Nº Cta Sb" Visible="False" />
                                        <asp:BoundField DataField="nro_cta_gastos" HeaderText="Nº Cta Gastos"
                                            Visible="False" />
            ...
            <ajaxToolkit:ModalPopupExtender runat="server" BehaviorID="modalMSJ" TargetControlID="Button1" ID="modalMSJ"
                PopupControlID="modMSJ" BackgroundCssClass="modalBackground">
