                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rv2" runat="server"
                                                    ValidationGroup="cliente" Text="Seleccione Tipo Liq" ForeColor="Red"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                                    ValidationGroup="cliente" Text="Ingrese la Descripcion de la Liq."
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <asp:TextBox ID="txtPeriodo" CssClass="input-control" runat="server">
                                                </asp:TextBox>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                    ValidationGroup="cliente" Text="Seleccione Banco" ForeColor="Red"
                                                    Display="Dynamic" InitialValue="0" ErrorMessage="Seleccione Banco"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                    ValidationGroup="cliente" Text="Ingrese Nombre del Archivo"
                                                    ForeColor="Red" Display="Dynamic"
                                                    ErrorMessage="Ingrese Nombre del Archivo"
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                    ValidationGroup="cliente" Text="Ingrese Porcentaje" ForeColor="Red"
                                                    Display="Dynamic" ErrorMessage="Ingrese Porcentaje"
                                    ...
                                    <div class="row">
                                        <div class="modal-header" style="background-color: #3587B2;">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"
                                                runat="server" id="btnCloseListado"
