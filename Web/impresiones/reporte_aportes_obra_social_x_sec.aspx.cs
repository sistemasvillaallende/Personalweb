...
{
    public partial class reporte_aportes_obra_social_x_sec : System.Web.UI.Page
    {
        ...
        {
            List<web.reportes.Aportes_obra_social> lst = new List<web.reportes.Aportes_obra_social>();
            lst = web.reportes.Aportes_obra_social.readAportes(Convert.ToInt32(Request.QueryString["anio"]),
        ...
        private void ConfigureCrystalReports(List<web.reportes.Aportes_obra_social> lst, string titulo_liq, string tipo_liq)
        {
            try
            {
                reporte.PrintOptions.PaperSize = PaperSize.PaperA4;
                reporte.Load(Server.MapPath("../reportes/raportes_obra_social.rpt"));
