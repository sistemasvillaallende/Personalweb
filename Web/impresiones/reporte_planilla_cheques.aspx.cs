...
{
    public partial class reporte_planilla_cheques : System.Web.UI.Page
    {
        ...
        {
            List<web.reportes.Planilla_Cheques> lst = new List<web.reportes.Planilla_Cheques>();
            lst = web.reportes.Planilla_Cheques.read(Convert.ToInt32(Request.QueryString["anio"]),
        ...
        private void ConfigureCrystalReports(List<web.reportes.Planilla_Cheques> lst, string titulo_liq, string tipo_liq)
        {
            try
            {
                reporte.PrintOptions.PaperSize = PaperSize.PaperA4;
                reporte.Load(Server.MapPath("../reportes/rplanilla_cheques.rpt"));
