...
{
    public partial class reporte_conceptos_fijos : System.Web.UI.Page
    {
        //
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lst = web.reportes.Conceptos_fijosRep.readResumen_cptos(anio, cod_tipo_liq, nro_liquidacion, fijo);
        ...
        private void ConfigureCrystalReports(List<web.reportes.Conceptos_fijosRep> lst, string titulo_liq, string tipo_liq, int fijo)
        {
            try
            {
                ...
                if (fijo == 1)
                    reporte.SetParameterValue("strTitulo", "CONCEPTOS VARIABLES");
                else
                    reporte.SetParameterValue("strTitulo", "CONCEPTOS FIJOS");
