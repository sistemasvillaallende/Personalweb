...
{
    public partial class reporte_aportes_jubilatorios_x_sec : System.Web.UI.Page
    {
        ...
        {
            List<web.reportes.Aportes_jubilatorios_x_sec> lst = new List<web.reportes.Aportes_jubilatorios_x_sec>();
            lst = web.reportes.Aportes_jubilatorios_x_sec.readAportes(Convert.ToInt32(Request.QueryString["anio"]),
        ...
        private void ConfigureCrystalReports(List<web.reportes.Aportes_jubilatorios_x_sec> lst, string titulo_liq, string tipo_liq)
        {
            try
            {
                reporte.PrintOptions.PaperSize = PaperSize.PaperA4;
                reporte.Load(Server.MapPath("../reportes/raportes_jubilatorios_x_sec.rpt"));
