...
{
    public partial class Personas_fichas : System.Web.UI.Page
    {
        //ACTUALIZADO
        ...
        private void fillResultados(int id)
        {
            ...
            lblTitulo.InnerText = string.Format("Evaluación realizada el: {0}",
                objRelevamiento.FECHA.ToShortDateString());
            lblNombreEvaluador.InnerHtml = objRelevamiento.USUARIO_RELEVA;
