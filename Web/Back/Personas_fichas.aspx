...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid shadow p-3 mb-5 bg-white rounded"
        ...
        <div class="box-header with-border" style="padding-top: 25px;">
            <div style="border-bottom: 1px solid #d2d6de; margin-bottom: 15px; padding-bottom: 15px; color: #666;">
                <div class="row">
                    <div class="col-md-4">
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-md-12">
                <h5 id="lblNombreEvaluacion" runat="server" style="font-size: 18px; color: var(--bs-secondary);">Nombre Evaluacion</h5>
            </div>
        </div>
        ...
        <div class="row" style="border: solid 3px lightgray; margin-left: 1px; margin-right: 5px; border-radius: 15px; padding-top: 10px;">
            <div class="box box-primary" id="divRespuestas" runat="server" visible="false">
                <div class="box-header ui-sortable-handle" style="cursor: move;">
                    <div class="row" style="padding-top: 15px; padding-left: 20px; padding-right: 20px; padding-bottom: 20px;">
                        <div class="col-md-8">
                            <h3 class="box-title" id="lblTitulo"
                                style="font-size: 18px; color: var(--bs-secondary);"
                                runat="server"></h3>
                        </div>
                        <div class="col-md-4">
                            <div class="btn-group pull-right" style="display:block;">
                                <button type="button" class="btn btn-info" id="btnNuevo" runat="server"
                                    ...
                                    Nuevo</button>
                                <a id="modal-60622" href="#modal-container-60622" role="button" class="btn btn-danger" data-toggle="modal">Eliminar
                                </a>
                                <div class="btn-group">
                    ...
                    <div class="box-tools">
                        <asp:DropDownList Visible="false" ID="DDLRelevamientos" CssClass="form-control" runat="server"></asp:DropDownList>
                    </div>
                </div>
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <div class="row" style="border: solid 1px darkgray; padding: 15px; border-radius: 15px; font-size: 18px; font-weight: 500;">
                                            <div class="col-md-8">
                                                <div id="divResultadoTotal" visible="false" runat="server">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
