<%@ Page Title="" Language="C#" MasterPageFile="~/MP/Bootstrap.Master" AutoEventWireup="true" 
    CodeBehind="informeconceptos.aspx.cs" Inherits="web.secure.informeconceptos" %>
                            ...
                            <div class="box-body">
                                <div class="box">
                                    ...
                                    <section class="content-header">
                                        <%--<div class="well span" style="padding-top: 50px">
                                            <h3>TITULO</h3>
                                        </div>--%>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <asp:TextBox ID="txtAnio" CssClass="form-control" TextMode="Number"
                                                            placeholder="Ingrese el Año" runat="server">
                                                        </asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="KD" runat="server" ValidationGroup="consulta"
                                                            Text="*" ForeColor="Red" Display="Dynamic" placeholder="Año"
                                                            ErrorMessage="Ingrese Año" ControlToValidate="txtAnio">
